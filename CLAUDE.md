...
- 향후 도입 시 후보: **Jest + React Native Testing Library**, Firebase mock, 순수 함수 우선 (`format.ts`, `validation.ts`, `chart.ts::mergeChartSeries`).
