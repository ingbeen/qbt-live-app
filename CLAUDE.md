...
- 기타: `react-native-gesture-handler`, `react-native-safe-area-context`, `react-native-screens`, `react-native-svg`, `react-native-uuid`, `@react-native-async-storage/async-storage` (식별자 저장 전용 — §6.4 예외)
